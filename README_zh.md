...
新增了通过 Kubernetes Custom Resource (CR) 进行 frp 服务端配置和状态管理的能力。这种方式特别适合在 Kubernetes 环境中部署和管理 frp。
...
* 在使用过程中出现任何问题，可以通过 [issues](https://github.com/imneov/kube-frp/issues) 来反馈。
...
**提醒：和项目相关的问题请在 [issues](https://github.com/imneov/kube-frp/issues) 中反馈，这样方便其他有类似问题的人可以快速查找解决方法，并且也避免了我们重复回答一些问题。**
